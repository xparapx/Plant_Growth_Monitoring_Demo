...
export const S = {
  ...
  host: {
    ...
    version: '버전', gitRev: 'git', camera: '카메라', mqtt: 'MQTT', wsClients: 'WS 클라이언트', dummyFill: 'dummy_fill', pid: 'pid',
  },
  ...
  config: {
    ...
    sections: { capture: '촬영 조건', layout: '배치', qc: '품질 기준', analysis: '분석', schedule: '스케줄', mqtt: 'MQTT', tz: '시간대', rois: 'ROI (읽기 전용)', treatMode: '배정 방식' },
